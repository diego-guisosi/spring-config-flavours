...
public class SpringAppConfiguration {
	...
	@Bean
	public MessagePrinter messagePrinter(MessageRepository messageRepository) {
		MessagePrinterImpl messagePrinterImpl = new MessagePrinterImpl();
		messagePrinterImpl.setMessageRepository(messageRepository);
		return messagePrinterImpl;
	}
